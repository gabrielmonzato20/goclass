...
type OrderServiceClient interface {
	...
	FindAllOrder(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*FindAllOrdersResponse, error)
}
...
func (c *orderServiceClient) FindAllOrder(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*FindAllOrdersResponse, error) {
...
type OrderServiceServer interface {
	...
	FindAllOrder(context.Context, *Empty) (*FindAllOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) FindAllOrder(context.Context, *Empty) (*FindAllOrdersResponse, error) {
...
func _OrderService_FindAllOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).FindAllOrder(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
